...
CREATE TABLE ms_t_stk_sis (
    ...
    ma_20   DECIMAL(16,4)  NULL     COMMENT '20-day moving average of closing price. NULL when fewer than 20 trading days. Pre-computed.',
    ma_50   DECIMAL(16,4)  NULL     COMMENT '50-day moving average of closing price. NULL when fewer than 50 trading days. Pre-computed.',
    ma_100  DECIMAL(16,4)  NULL     COMMENT '100-day moving average of closing price. NULL when fewer than 100 trading days. Pre-computed.',
    ma_3    DECIMAL(16,4)  NULL     COMMENT '3-day moving average of closing price. NULL when fewer than 3 trading days. Pre-computed.',
